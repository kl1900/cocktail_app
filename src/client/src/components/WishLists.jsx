...
//   if (wishlistId%5 === 0) {
//     return "https://st3.depositphotos.com/1000604/34174/i/450/depositphotos_341745306-stock-photo-vegetables-greens-and-herbs-on.jpg";
//   } else if (wishlistId%5 === 1) {
//     return "https://st2.depositphotos.com/1014889/7900/i/450/depositphotos_79008782-stock-photo-vegetables.jpg";
//   } else if (wishlistId%5 === 2) {
//     return "https://st2.depositphotos.com/1014889/7349/i/450/depositphotos_73493279-stock-photo-vegetables.jpg";
//   } else if (wishlistId%5 === 3) {
//     return "https://st2.depositphotos.com/1014889/7900/i/450/depositphotos_79006254-stock-photo-vegetables.jpg";
//   } else if (wishlistId%5 === 4) {
//     return "https://st2.depositphotos.com/1194063/11986/i/450/depositphotos_119865394-stock-photo-assortment-of-the-fresh-vegetables.jpg";
//   }
// };
              ...
              {wishlists.map((wishlist, i) => (
                ...
                <div className="wishlist-row">
                    ...
                    <div>
                      {editMode[i]?(
                        <div>
                          <EditWishlist wishlistId={wishlist.id} changeToFalse={()=>changeToFalse(i)} countNum={countNum}/>
                        </div>
                      ):(
                       <div>
                          <div>{wishlist.title}</div>
                          <div style={{cursor: "pointer"}} onClick={()=>changeToTrue(i)}>
                            <ImPencil/>
                          </div>
                        </div>
                        )
